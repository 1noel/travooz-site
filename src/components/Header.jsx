      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex justify-between items-center gap-3 lg:gap-5">
          ...
          <div className="space-x-2 lg:space-x-4">
            ...
            <button className="bg-white text-green-600 px-3 lg:px-5 py-1.5 rounded-md text-sm lg:text-base">
              Sign in
            </button>
          </div>
        </div>
        ...
        <div className="md:hidden mt-4 pt-4 border-t border-green-500">
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex space-x-3">
              ...
              <button className="bg-white text-green-600 px-4 py-2 rounded-md text-sm flex-1">
                Sign in
              </button>
            </div>
          </div>
