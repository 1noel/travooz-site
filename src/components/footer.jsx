                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className='flex flex-col space-y-4'>
                        ...
                        <p className="text-sm text-gray-600">
                            We are a company dedicated to providing the best travel experiences in Rwanda and beyond.
                        </p>
                        {/* Social Media Links */}
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><a href="/hotels" className="text-gray-600 hover:text-green-600 transition-colors">Hotels</a></li>
                            <li><a href="/eating-out" className="text-gray-600 hover:text-green-600 transition-colors">Restaurants</a></li>
                            <li><a href="/activities" className="text-gray-600 hover:text-green-600 transition-colors">Activities</a></li>
                            <li><a href="/tour-packages" className="text-gray-600 hover:text-green-600 transition-colors">Tour Packages</a></li>
                            <li><a href="/cars" className="text-gray-600 hover:text-green-600 transition-colors">Car Rental</a></li>
                            <li><a href="/blogs" className="text-gray-600 hover:text-green-600 transition-colors">Travel Blogs</a></li>
                        </ul>
                    </div>
