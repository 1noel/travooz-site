    ...
    <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20 space-y-5 mt-10">
          ...
          {filteredCars.slice(1).map((car) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  {(() => {
                    ...
                    return (
                      <span
                        className={`px-2 md:px-3 py-1 md:py-1.5 rounded-full text-xs md:text-sm font-semibold text-white ${
                          availability.color === "green"
                            ? "bg-green-600"
                            : availability.color === "red"
                            ? "bg-red-600"
              ...
              <div className="p-4 md:p-6">
                ...
                {/* Features - Only show if they exist */}
      ...
      <div className="bg-green-50 rounded-xl p-6 md:p-8 text-center border border-green-100">
        ...
        <p className="text-gray-600 mb-6 text-base md:text-lg">
          Can't find what you're looking for? Contact us for special requests or
